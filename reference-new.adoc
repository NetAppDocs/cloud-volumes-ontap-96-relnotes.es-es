...
* https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-gcp.html["Descubra cómo comenzar a usar Google Cloud"^]
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-tiering.html["Descubra cómo configurar la organización en niveles de los datos en Cloud Manager"^].
